(function() {
  ...
  function init() {
    ...
    document.querySelector("#register-btn").addEventListener("clicl", register);
   ...
   */
  function ajax(method, url, data, successfulCallback, errorCallback) {
  ...
  function activeBtn(btnId) {
    var btns = document.querySelector(".main-nav-btn");
